...
var eventListeners = {
  activatePvpStart: function activatePvpStart() {
    _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.pvpStartButton.addEventListener('click', function () {
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activePlayer = new _player__WEBPACK_IMPORTED_MODULE_1__.Human(_renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.player1Name.value);
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activeGameboard = _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.gameboardOne;
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactivePlayer = new _player__WEBPACK_IMPORTED_MODULE_1__.Human(_renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.player2Name.value);
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactiveGameboard = _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.gameboardTwo;
      _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.pvpDialog.close();
      _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.renderGameboard(_gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activePlayer, _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activeGameboard);
      _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.renderGameboard(_gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactivePlayer, _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactiveGameboard);
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.shipPlacement();
    });
  },
  activatePvcStart: function activatePvcStart() {
    _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.pvcStartButton.addEventListener('click', function () {
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activePlayer = new _player__WEBPACK_IMPORTED_MODULE_1__.Human(_renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.player1Name.value);
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activeGameboard = _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.gameboardOne;
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactivePlayer = new _player__WEBPACK_IMPORTED_MODULE_1__.Computer();
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactiveGameboard = _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.gameboardTwo;
      _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.pvcDialog.close();
      _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.renderGameboard(_gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activePlayer, _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.activeGameboard);
      _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.renderGameboard(_gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactivePlayer, _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.inactiveGameboard);
      _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.shipPlacement();
    });
    ...
    return new Promise(function (resolve) {
      boardCoords.forEach(function (item) {
        item.addEventListener('click', function (e) {
          ...
          var column = index % 10;
          var message = player.gameboard.placeShip(name, length, row, column);
          setTimeout(function () {
            _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.alert.textContent = message;
          }, 2000);
    ...
    boardCoords.forEach(function (item) {
      if (!item.classList.contains('hit') && !item.classList.contains('miss')) {
        item.addEventListener('click', function (e) {
          ...
          _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.message.textContent = message;
          _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.renderOpponent(player, element);
          if (player.gameboard.checkFleet() === true) {
            _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.message.textContent = _gameFlow__WEBPACK_IMPORTED_MODULE_2__.gameFlow.endGame();
          }
        });
      }
    });
...
var gameFlow = {
  ...
  initPvpMode: function initPvpMode() {
    ...
    _eventListeners__WEBPACK_IMPORTED_MODULE_1__.eventListeners.activatePvpStart();
  },
  initPvcMode: function initPvcMode() {
    _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.startDialog.close();
    _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.pvcDialog.showModal();
    _eventListeners__WEBPACK_IMPORTED_MODULE_1__.eventListeners.activatePvcStart();
  },
  shipPlacement: function shipPlacement() {
    var _this = this;
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var shipLengths, shipNames, i, result, _i, _result;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            i = 0;
          case 3:
            if (!(i < shipLengths.length)) {
              _context.next = 12;
              break;
            }
            _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.message.textContent = "".concat(_this.activePlayer.name, ", place your ").concat(shipNames[i].toLowerCase(), " on the board");
            _context.next = 7;
          ...
          case 14:
            ...
            _renderDom__WEBPACK_IMPORTED_MODULE_0__.domElements.message.textContent = "".concat(_this.inactivePlayer.name, ", place your ").concat(shipNames[_i].toLowerCase(), " on the board");
            _context.next = 18;
...
var domElements = {
  ...
  renderShip: function renderShip(element, length) {
    var ship = document.createElement('div');
    ship.classList.add('ship-display');
    element.appendChild(ship);
    for (var i = 0; i < length; i++) {
      var shipUnit = document.createElement('div');
  ...
  toggleTurnButton: function toggleTurnButton(player) {
    ...
    this.turnButton.textContent === 'Switch Turn' ? function () {
      _this.turnButton.textContent = 'Begin Turn';
      _this.turnButton.classList.add('begin-button');
      _this.message.textContent = "".concat(player, "'s Turn");
    }() : function () {
      _this.turnButton.classList.remove('begin-button');
      _this.turnButton.textContent = 'Switch Turn';
    }();
  }
};
...
`, "",{"version":3,"sources":["webpack://./src/styles/main.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,8BAA8B;AAChC;;AAEA;;EAEE,WAAW;EACX,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,oCAAoC;EACpC,2BAA2B;AAC7B;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,OAAO;AACT;;AAEA;EACE,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,qCAAqC;AACvC;;AAEA;EACE,aAAa;EACb,qCAAqC;AACvC;;AAEA;EACE,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,sBAAsB;EACtB,YAAY;EACZ,UAAU;EACV,aAAa;EACb,sBAAsB;EACtB,6BAA6B;EAC7B,mBAAmB;EACnB,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,sCAAsC;EACtC,QAAQ;AACV;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,uBAAuB;EACvB,aAAa;EACb,mBAAmB;EACnB,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,oCAAoC;AACtC;;AAEA;EACE,aAAa;EACb,6BAA6B;AAC/B;;AAEA;EACE,aAAa;EACb,uBAAuB;EACvB,sBAAsB;EACtB,SAAS;AACX;;AAEA;EACE,aAAa;EACb,QAAQ;AACV;;AAEA;EACE,YAAY;EACZ,WAAW;EACX,oCAAoC;EACpC,uBAAuB;EACvB,kBAAkB;AACpB","sourcesContent":["body {\n  height: 100vh;\n  width: 100vw;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n\nheader,\nfooter {\n  width: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\ndialog {\n  border-radius: 10px;\n}\n\ndialog::backdrop {\n  background-color: rgba(0, 0, 0, 0.7);\n  backdrop-filter: blur(12px);\n}\n\n.dialog-button-container {\n  display: flex;\n  justify-content: center;\n  gap: 5%;\n}\n\n.mode-button {\n  font-size: 24px;\n  border-radius: 5px;\n}\n\n#single-input-container {\n  display: grid;\n  grid-template-columns: repeat(1, 1fr);\n}\n\n#dual-input-container {\n  display: grid;\n  grid-template-columns: repeat(2, 1fr);\n}\n\n#title {\n  font-size: 100px;\n  text-align: center;\n}\n\n#gameboard-container {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n#ui-container {\n  box-sizing: border-box;\n  height: 100%;\n  width: 20%;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly;\n  align-items: center;\n  padding-left: 3%;\n  padding-right: 3%;\n}\n\n#message-container {\n  flex-grow: 1;\n  text-align: center;\n  font-size: 32px;\n}\n\n#button-container {\n  flex-grow: 1;\n  display: grid;\n  place-items: center;\n}\n\n.gameboard {\n  display: grid;\n  grid-template-columns: repeat(10, 1fr);\n  gap: 1px;\n}\n\n.coordinate {\n  height: 50px;\n  width: 50px;\n  border: solid black 2px;\n  display: grid;\n  place-items: center;\n  font-size: 30px;\n  border-radius: 5px;\n}\n\n.ship {\n  background-color: rgb(113, 197, 113);\n}\n\n.hit {\n  background-color: rgb(255, 129, 129);\n}\n\n.miss {\n  background-color: rgb(133, 133, 255);\n}\n\n#ship-info-container {\n  display: flex;\n  justify-content: space-around;\n}\n\n.ship-info {\n  display: flex;\n  justify-content: center;\n  flex-direction: column;\n  gap: 30px;\n}\n\n.ship-display {\n  display: flex;\n  gap: 1px;\n}\n\n.ship-unit {\n  height: 30px;\n  width: 30px;\n  background-color: rgb(113, 197, 113);\n  border: solid black 1px;\n  border-radius: 3px;\n}\n"],"sourceRoot":""}]);
// Exports
...
_renderDom__WEBPACK_IMPORTED_MODULE_2__.domElements.turnButton.addEventListener('click', function (e) {
  if (e.target.classList.length === 0) {
    _gameFlow__WEBPACK_IMPORTED_MODULE_3__.gameFlow.switchScreen();
  } else if (e.target.classList.contains('begin-button')) {
    _gameFlow__WEBPACK_IMPORTED_MODULE_3__.gameFlow.switchActive();
    _gameFlow__WEBPACK_IMPORTED_MODULE_3__.gameFlow.displayBoards();
